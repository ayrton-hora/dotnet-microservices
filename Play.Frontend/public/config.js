...
window.CATALOG_SERVICE_URL = 'https://localhost:7109'
window.CATALOG_ITEMS_API_URL = `${window.CATALOG_SERVICE_URL}/Items/GetAsync`
window.INVENTORY_SERVICE_URL = 'https://localhost:7221'
window.INVENTORY_ITEMS_API_URL = `${window.INVENTORY_SERVICE_URL}/Items/Get`
